...
function Feature(props) {
    ...
    const participantes = [
        ...
        'Todas las personas naturales y jurídicas afiliadas o no a las cajas de compensación que integran a Fedecajas',
        'Mayores de 18 años, para menores de edad se debe contar con la supervición y autorización del acudiente encargado'
    ]
